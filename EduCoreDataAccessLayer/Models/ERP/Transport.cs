namespace EduCoreDataAccessLayer.Models.ERP
{
    ...
    public class TransportVehicle
    {
        ...
        /// <summary>The assigned driver (core.staff). Name/phone below are a snapshot of this staff row.</summary>
    ...
    /// <summary>A driver/conductor (Transport-type staff) for the vehicle dropdown.</summary>
    public class TransportDriverOption
    {
